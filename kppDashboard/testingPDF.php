                            ...
                            <tr>
                              ...
                              <td width="50%">
                                <div style="font-family: helvetica">
                                  ...
                                  <span style="color: #555; white-space: nowrap">11/9/2024</span>
                                </div>
                              </td>
                            </tr>
                          </table>
                          ...
                          <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color: #000000; font-family: Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; table-layout: auto; width: 100%; border: none">
                            <tr>
                              <td style="vertical-align: top">
                                ...
                                <div class="company-info" style="color: #555; font-family: helvetica">ahmad abu</div>
                              ...
                              <td width="50%" v-align="top" style="vertical-align: top">
                                ...
                                <div class="company-info" style="color: #555; font-family: helvetica"></div>
                                
                                <div class="company-info" style="color: #555; font-family: helvetica">Company number: 0123132123</div>
                                
                                <div class="company-info" style="color: #555; font-family: helvetica">VAT number: 12313123</div>
                                
                                <div class="company-info" style="color: #555; font-family: helvetica">kubang pasu</div>
                                <div class="company-info" style="color: #555; font-family: helvetica">17000, kubang kerian</div>
                                <div class="company-info" style="color: #555; font-family: helvetica">kelantan</div>
                                <div class="company-info" style="color: #555; font-family: helvetica">lktn@gmail.com_create_guid</div>
                                <div class="company-info" style="color: #555; font-family: helvetica">0912313213</div>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                          <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color: #000000; font-family: Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; table-layout: auto; width: 100%; border: none">
                            ...
                            <tr>
                              <td class="td-line-item" style="color: #555; padding: 10px 0; font-family: helvetica; border-bottom: 1px solid #ddd">membersih</td>
                              <td class="td-line-item nowrap" align="left" style="color: #555; padding: 10px 0; font-family: helvetica; border-bottom: 1px solid #ddd; white-space: nowrap">2</td>
                              <td class="td-line-item nowrap" align="right" style="color: #555; padding: 10px 0; font-family: helvetica; border-bottom: 1px solid #ddd; white-space: nowrap">100</td>
                              <td class="td-line-item nowrap" align="right" style="color: #555; padding: 10px 0; font-family: helvetica; border-bottom: 1px solid #ddd; white-space: nowrap">2</td>
                            </tr>
                            {% endfor %}
                            <tr>
                              <td></td>
                              ...
                              <td style="border-top: 1px solid #555; color: #555; padding: 10px 0; font-family: helvetica; border-bottom: 1px solid #ddd; white-space: nowrap" align="right">100</td>
                            </tr>
                            <tr>
                              <td></td>
                              <td style="color: #555; padding: 10px 0; font-family: helvetica" align="left" colspan="2">VAT (12312):</td>
                              <td style="color: #555; padding: 10px 0; font-family: helvetica; white-space: nowrap" align="right">123123</td>
                            </tr>
                            <tr>
                              <td></td>
                              ...
                              <td style="border-top: 1px solid #777; color: #333; padding: 10px 0 0 0; font-family: helvetica; white-space: nowrap" align="right"><strong>12313</strong></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                ...
                <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size: 0px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%">
                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align: top" width="100%">
                    <tbody>
                      ...
                      <tr>
                        <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                          <div style="font-family: helvetica; font-size: 13px; line-height: 1; text-align: left; color: #555555">infoinfo</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
