            ...
            <div class="recentOrders">
                ...
                <form>
                    ...
                    <div class="input-group mb-2">
                        ...
                        <button class="btn btn-outline-secondary" type="button" onclick="window.open('controller/getPDF_quotation_deposit.php?id=<?php echo $tempahan['tempahan_id']; ?>', '_blank')">Lihat Sebut Harga</button>
                    </div>
                        ...
                        <div class="input-group mb-2">
                            ...
                            <button class="btn btn-outline-secondary" type="button" onclick="window.open('controller/getPDF_quotation_fullpayment.php?id=<?php echo $tempahan['tempahan_id']; ?>', '_blank')">Lihat Sebut Harga</button>
                        </div>
