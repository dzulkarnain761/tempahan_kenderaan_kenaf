...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $new_image_name = $tempahan_id . '_bayaran_penuh.' . strtolower(pathinfo($image, PATHINFO_EXTENSION));
        ...
        try {
            ...
            if (move_uploaded_file($_FILES['gambar_resit']['tmp_name'], $target_file)) {
                ...
                $sqlResit = "UPDATE resit_pembayaran 
                             ...
                             WHERE tempahan_id = $tempahan_id AND jenis_pembayaran = 'bayaran penuh'";
