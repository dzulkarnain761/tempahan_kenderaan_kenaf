                ...
                <div class="recentOrders">
                    ...
                    <div class="mb-3">
				        ...
				        <div class="mb-3">
                            ...
                            <input type="time" class="form-control" placeholder="masa mula">
                        </div>
                        <div class="mb-3">
                            <label for="sewa" class="form-label">Odometer Masa Akhir</label>
                            <input type="time" class="form-control" placeholder="masa akhir">
                        </div>
                        <div class="mb-3">
                            <label for="sewa" class="form-label">Jumlah Jam Kerja</label>
                            <input type="text" class="form-control" placeholder="Jumlah Jam Kerja" value="0">
                        </div>
                        <div class="mb-3">
                            <label for="sewa" class="form-label">Jumlah Bayaran (RM)</label>
                            <input type="text" class="form-control" placeholder="Jumlah Bayaran" value="0">
                        </div>
