...
CREATE TABLE `jobsheet` (
  ...
  `status_jobsheet` enum('pengesahan','dijalankan','selesai') DEFAULT 'pengesahan',
...
CREATE TABLE `kenderaan` (
  `id` int(11) NOT NULL,
  `kategori_kenderaan` varchar(50) DEFAULT NULL,
  `no_aset` varchar(50) DEFAULT NULL,
  `no_pendaftaran` varchar(20) DEFAULT NULL,
  `tahun_daftar` varchar(10) DEFAULT NULL,
  `negeri_penempatan` varchar(50) DEFAULT NULL,
  `kawasan_penempatan` varchar(50) DEFAULT NULL,
...
CREATE TABLE `negeri` (
  `id_negeri` int(11) NOT NULL,
  `nama_negeri` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `payment` (
  `pid` int(11) NOT NULL,
  `rsp_appln_id` varchar(3) DEFAULT NULL,
  `rsp_org_id` varchar(10) DEFAULT NULL,
  `rsp_orderid` varchar(20) DEFAULT NULL,
  `rsp_amount` decimal(10,2) DEFAULT NULL,
  `rsp_trxstatus` varchar(15) DEFAULT NULL,
  `rsp_stcode` varchar(3) DEFAULT NULL,
  `rsp_bankid` varchar(15) DEFAULT NULL,
  `rsp_bankname` varchar(50) DEFAULT NULL,
  `rsp_fpxid` varchar(30) DEFAULT NULL,
  `rsp_fpxorderno` varchar(30) DEFAULT NULL,
  `date_created` datetime DEFAULT current_timestamp(),
  `type` int(11) DEFAULT 0 COMMENT '0 = fpx, 1 = cek, 2 = cash, 3 = EFT, 4= Kad',
...
CREATE TABLE `tempahan` (
  ...
  `status_bayaran` enum('dalam pengesahan','belum bayar','bayaran diproses','selesai bayaran','ditolak','dibatalkan','selesai','refund','bayaran tambahan') DEFAULT 'dalam pengesahan',
...
CREATE TABLE `tugasan` (
  ...
  `kategori_kenderaan` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `jobsheet`
  MODIFY `jobsheet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;
...
--
ALTER TABLE `resit_pembayaran`
  MODIFY `resit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT for table `tempahan`
--
ALTER TABLE `tempahan`
  MODIFY `tempahan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT for table `tempahan_kerja`
--
ALTER TABLE `tempahan_kerja`
  MODIFY `tempahan_kerja_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202;
