...
<body>
    <div class="custom-container">
        ...
        <div class="main">
            ...
            <div class="recentOrders">
                ...
                <form class="tambahTugasanTraktor" novalidate>
                    <div class="mb-3">
    ...
    <script>
        (() => {
            ...
            const forms = document.querySelectorAll('.tambahTugasanTraktor')
        ...
        $(document).ready(function() {
            $('.tambahTugasanTraktor').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    url: 'controller/add_tugasan_traktor.php',
                    type: 'POST',
                    data: $(this).serialize(),
