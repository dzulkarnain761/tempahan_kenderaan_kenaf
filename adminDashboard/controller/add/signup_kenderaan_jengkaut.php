...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkSql = $conn->prepare("SELECT * FROM kenderaan_jengkaut WHERE no_pendaftaran = ?");
    ...
    $sql = $conn->prepare("INSERT INTO kenderaan_jengkaut (no_aset, no_pendaftaran, tahun_daftar, negeri_penempatan, kawasan_penempatan,harga_belian, catatan, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $kumpulan = 'Y';
