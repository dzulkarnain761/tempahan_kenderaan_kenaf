...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkSql = $conn->prepare("SELECT * FROM kenderaan_jengkaut WHERE id != ? AND no_pendaftaran = ?");
    ...
    $sql = $conn->prepare("UPDATE kenderaan_jengkaut SET no_aset = ?, no_pendaftaran = ?, tahun_daftar = ?,  negeri_penempatan = ?, kawasan_penempatan = ?, harga_belian = ?, catatan = ?, status = ? WHERE id = ?");
