        ...
        <div class="main">
            ...
            <div class="recentOrders">
                <div class="cardHeader">
                    <h2>SENARAI JENGKAUT</h2>
                    <a class="btn" onclick="window.location.href = 'daftar_kenderaan_jengkaut.php'">DAFTAR JENGKAUT</a>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr data-id="<?php echo $row['id']; ?>">
                                ...
                                <td>
                                    <button onclick="window.location.href = 'kemaskini_kenderaan_jengkaut.php?id=<?php echo $row['id']; ?>'" class="btn btn-outline-edit">
        ...
        function deleteItem(button) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'controller/delete/delete_kenderaan_jengkaut.php',
                        type: 'POST',
                        data: {
                            id: kenderaanId
                        },
